...
frappe.ui.form.on("EOY Bonus Payroll Entry", {
	onload: function (frm) {
	...
	set_start_end_dates: function (frm) {
		if (!frm.doc.salary_slip_based_on_timesheet) {
			frappe.call({
				method: "hrms.payroll.doctype.eoy_bonus_payroll_entry.eoy_bonus_payroll_entry.get_start_end_dates",
				args: {
	...
	set_end_date: function (frm) {
		frappe.call({
			method: "hrms.payroll.doctype.eoy_bonus_payroll_entry.eoy_bonus_payroll_entry.get_end_date",
			args: {
